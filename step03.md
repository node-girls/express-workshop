...
- Right click the `Run` button on the top menu and select `New Run Configuration` from the menu. This will open the Run Panel at the bottom of your workspace.
